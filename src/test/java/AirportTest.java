...
public class AirportTest {
    ...
    @BeforeClass
    public void ititializeListsObjects() {
    ...
    public void testHasNextPlaneMaxLoadCapacityIsHigherThanCurrent() {
        Assert.assertTrue(airport.isHasNextPlaneMaxCapacity(planes));
    }

    @Test
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        Assert.assertTrue(airport.isAtLeastOneBomberInMilitaryPlanes(planes));
    }

    @Test
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified() {
        Assert.assertFalse(airport.isExperimentalPlanesHasClassificationLevelHigherThanUnclassified(planes));
    }
}
